...
<head>
    ...
    <link rel="stylesheet" href="{{asset('pdf-flip.css')}}"/>
    <style>
        .se-pre-con {
            position: fixed;
            left: 0px;
            ...
            height: 100%;
            z-index: 9999;
            background: url("{{asset('pics/loader.gif')}}") center no-repeat #fff;
        }
    </style>
</head>
        ...
        <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
            <div id="secondaryToolbarButtonContainer">
                ...
                <button id="documentProperties" class="secondaryToolbarButton documentProperties"
                    ...
                    <span data-l10n-id="document_properties_label">Document Propertiesaa�</span>
                </button>
            </div>
        </div>
        <!-- secondaryToolbar -->
            ...
            <div id="toolbarContainer">
                <div id="toolbarViewer" >
                    ...
                    <div id="toolbarViewerRight">
                        ...
                        <button onclick="location.href = 'http://www.troti.review';" class="toolbarButton hiddenMediumView" title="Home">Home
                        </button>
...
<script src="{{asset('pdfjs/compatibility.js')}}"></script>
<!-- This snippet is used in production (included from viewer.html) -->
<link rel="resource" type="application/l10n" href="{{asset('pdfjs/locale/locale.properties')}}"/>
<script src="https://code.jquery.com/jquery-2.1.4.min.js"></script>
<script src="{{asset('turnjs/turn.min.js')}}"></script>
<script src="{{asset('turnjs/zoom.min.js')}}"></script>
<script src="{{asset('pdfjs/l10n.js')}}"></script>
<script src="{{asset('pdfjs/build/pdf.js')}}"></script>
<script src="{{asset('pdfjs/debugger.js')}}"></script>
<script src="{{asset('pdfjs/viewer.js')}}"></script>
<script src="{{asset('pdf-flip.js?v=1.1.1.1.1.1')}}"></script>
